...
Going to the original provided GoogleDrive dataset, search on Notes in Type (`Type Note`) that say `military|bunker` , case insensitive, to gauge the number of features which have been reused for military purposes. 

After you figure out the number, print out a message stating the fraction of the mounds that were converted to military.
...
# message
paste0("During 2022, ",nrow(military), " of the verified ", nrow(mounds22), " features (",round(nrow(military)/nrow(mounds22)*100, digits=2),"%) were converted for military purposes.")
